...
(declare-rel IND_VAR (ind BitSet))
...
;;; TEST ;;;;;;;
(rule (REC_RAND_VAR #x66 #x1 #x1))
(rule (REC_RAND_VAR #x66 #x2 #x0))
(rule (REC_RAND_VAR #x67 #x1 #x2))
(rule (REC_RAND_VAR #x67 #x2 #x0))
(rule (REC_ALL_INC #x66 #x1 #x1))
(rule (REC_ALL_INC #x66 #x2 #x0))
(rule (REC_ALL_INC #x67 #x1 #x2))
(rule (REC_ALL_INC #x67 #x2 #x0))
...
(rule (=> (and (BVAND_REC var_x var_y var_z Times) (not (= Times #x0)) (= Times_New (bvsub Times #x1))) (BVAND_REC var_x var_y var_z Times_New)))
;; BV [AND] = [KEY] && [ALL_INC]
(rule (=> (and (REC_ALL_INC var_x Times X) (KEY_NUMBER Times KEY_NUM) (BVAND X KEY_NUM int_res0) (= Times #x1)) (BVAND_ALL_KEY_REC var_x Times int_res0)))
(rule (=> (and (BVAND_ALL_KEY_REC var_x Times_New int_res0) (REC_ALL_INC var_x Times X) (KEY_NUMBER Times KEY_NUM) (BVAND X KEY_NUM int_res1) (= Times_New (bvsub Times #x1)) (not (= Times #x1)) (BVOR int_res0 int_res1 int_res2)) (BVAND_ALL_KEY_REC var_x Times int_res2)))
;; BV [OR] [RAND_VAR]
...
(rule (=> (and (BVOR_RAND_REC var_x var_y var_z Times) (not (= Times #x0)) (= Times_New (bvsub Times #x1))) (BVOR_RAND_REC var_x var_y var_z Times_New)))
;; BV [OR] [ALL_INC]
...
(rule (=> (and (BVOR_ALL_REC var_x var_y var_z Times) (not (= Times #x0)) (= Times_New (bvsub Times #x1))) (BVOR_ALL_REC var_x var_y var_z Times_New)))
;; BV [Intersect] [ALL_INC]
(rule (=> (and (REC_ALL_INC var_x Times X) (REC_ALL_INC var_y Times Y) (= Times #x1) (BV_Intersect X Y XY)(INTERSECT_LABEL var_x var_y)) (BV_INTERSECT_REC var_x var_y Times XY)))
(rule (=> (and (REC_RAND_VAR var_x Times X) (REC_ALL_INC var_y Times Y) (not (= Times #x1)) (BV_Intersect X Y XY) (INTERSECT_LABEL var_x var_y) (= Times_New (bvsub Times #x1)) (BV_INTERSECT_REC var_x var_y Times_New XY_past) (BVOR XY XY_past int_res0)) (BV_INTERSECT_REC var_x var_y Times int_res0)))
;; BV [DIFF] [RAND_VAR]\[ALL_INC]
(rule (=> (and (REC_RAND_VAR var_x Times X) (REC_ALL_INC var_y Times Y) (= Times #x1) (BV_Diff X Y XY) (DIFF_LABEL var_x var_y)) (BV_DIFF_REC var_x var_y Times XY)))
(rule (=> (and (REC_RAND_VAR var_x Times X) (REC_ALL_INC var_y Times Y) (not (= Times #x1)) (BV_Diff X Y XY) (DIFF_LABEL var_x var_y) (= Times_New (bvsub Times #x1)) (BV_DIFF_REC var_x var_y Times_New XY_past) (BVOR XY XY_past int_res0)) (BV_DIFF_REC var_x var_y Times int_res0)))
...
(rule (=> (and (SET_SUM_REC var_x var_y var_z Times) (not (= Times_New #x0)) (= Times_New (bvsub Times #x1))) (SET_SUM_REC var_x var_y var_z Times_New)))
...
(rule (=> (and (XOR_RUD1_ALL_INC_REC var_x var_y var_z Times) (= Times_New (bvsub Times #x1)) (not (= Times_New #x0))) (XOR_RUD1_ALL_INC_REC var_x var_y var_z Times_New)))
...
(rule (=> (and (BV_EQUAL_RAND_REC var_x var_y Times) (= Times_New (bvsub Times #x1)) (not (= Times_New #x0))) (BV_EQUAL_RAND_REC var_x var_y Times_New)))
...
(rule (=> (and (BV_EQUAL_ALL_REC var_x var_y Times) (= Times_New (bvsub Times #x1)) (not (= Times_New #x0))) (BV_EQUAL_ALL_REC var_x var_y Times_New)))
;; BV [BV_ZERO] ;; [RAND]
(rule (=> (and (REC_RAND_VAR var_x Times X) (BV_ZERO_REC var_x var_y Times) (= XY #x0)) (REC_RAND_VAR var_y Times XY)))
(rule (=> (and (BV_ZERO_REC var_x var_y Times) (= Times_New (bvsub Times #x1)) (not (= Times_New #x0))) (BV_ZERO_REC var_x var_y Times_New)))
;; BV [IS EMPTY] [RAND_VAR]
(rule (=> (and (REC_RAND_VAR var_x Times X) (= Times #x1) (ISEMPTY X int_bool0)) (BV_IS_EMPTY_REC var_x Times int_bool0)))
(rule (=> (and (REC_RAND_VAR var_x Times X) (ISEMPTY X int_bool0) (not (= Times #x1)) (= Times_New (bvsub Times #x1)) (BV_IS_EMPTY_REC var_x Times_New int_bool1)) (BV_IS_EMPTY_REC var_x Times (and int_bool0 int_bool1))))
...
(rule (Time #x8))
;; RAND_NUMBER
(rule (RAND_NUMBER #x1 #b0111))
(rule (RAND_NUMBER #x2 #b0000))
(rule (RAND_NUMBER #x3 #b0000))
(rule (RAND_NUMBER #x4 #b0000))
(rule (RAND_NUMBER #x5 #b0000))
(rule (RAND_NUMBER #x6 #b0000))
(rule (RAND_NUMBER #x7 #b0000))
(rule (RAND_NUMBER #x8 #b0000))
(rule (KEY_NUMBER #x1 #b1000))
(rule (KEY_NUMBER #x2 #b0000))
(rule (KEY_NUMBER #x3 #b0000))
(rule (KEY_NUMBER #x4 #b0000))
(rule (KEY_NUMBER #x5 #b0000))
(rule (KEY_NUMBER #x6 #b0000))
(rule (KEY_NUMBER #x7 #b0000))
(rule (KEY_NUMBER #x8 #b0000))
; user specify the sensitive variable
(rule (KEY_SENSITIVE #b00000100))
;(rule (KEY_NUMBER #b1000)) ; #b1000
(rule (REC_RAND_VAR #b00000100 #x1 #b0000))
(rule (REC_RAND_VAR #b00000100 #x2 #b0000))
(rule (REC_RAND_VAR #b00000100 #x3 #b0000))
(rule (REC_RAND_VAR #b00000100 #x4 #b0000))
(rule (REC_RAND_VAR #b00000100 #x5 #b0000))
(rule (REC_RAND_VAR #b00000100 #x6 #b0000))
(rule (REC_RAND_VAR #b00000100 #x7 #b0000))
(rule (REC_RAND_VAR #b00000100 #x8 #b0000))
(rule (REC_ALL_INC #b00000100 #x1 #b1000))
(rule (REC_ALL_INC #b00000100 #x2 #b0000))
(rule (REC_ALL_INC #b00000100 #x3 #b0000))
(rule (REC_ALL_INC #b00000100 #x4 #b0000))
(rule (REC_ALL_INC #b00000100 #x5 #b0000))
(rule (REC_ALL_INC #b00000100 #x6 #b0000))
(rule (REC_ALL_INC #b00000100 #x7 #b0000))
(rule (REC_ALL_INC #b00000100 #x8 #b0000))
; all the key value occupied bit are all "1"

;(rule (RAND #b00000001))
(rule (RAND #b00000001))
(rule (REC_RAND_VAR #b00000001 #x1 #b0001))
(rule (REC_RAND_VAR #b00000001 #x2 #b0000))
(rule (REC_RAND_VAR #b00000001 #x3 #b0000))
(rule (REC_RAND_VAR #b00000001 #x4 #b0000))
(rule (REC_RAND_VAR #b00000001 #x5 #b0000))
(rule (REC_RAND_VAR #b00000001 #x6 #b0000))
(rule (REC_RAND_VAR #b00000001 #x7 #b0000))
(rule (REC_RAND_VAR #b00000001 #x8 #b0000))
(rule (REC_ALL_INC #b00000001 #x1 #b0001))
(rule (REC_ALL_INC #b00000001 #x2 #b0000))
(rule (REC_ALL_INC #b00000001 #x3 #b0000))
(rule (REC_ALL_INC #b00000001 #x4 #b0000))
(rule (REC_ALL_INC #b00000001 #x5 #b0000))
(rule (REC_ALL_INC #b00000001 #x6 #b0000))
(rule (REC_ALL_INC #b00000001 #x7 #b0000))
(rule (REC_ALL_INC #b00000001 #x8 #b0000))
(rule (RAND #b00000010))
(rule (REC_RAND_VAR #b00000010 #x1 #b0010))
(rule (REC_RAND_VAR #b00000010 #x2 #b0000))
(rule (REC_RAND_VAR #b00000010 #x3 #b0000))
(rule (REC_RAND_VAR #b00000010 #x4 #b0000))
(rule (REC_RAND_VAR #b00000010 #x5 #b0000))
(rule (REC_RAND_VAR #b00000010 #x6 #b0000))
(rule (REC_RAND_VAR #b00000010 #x7 #b0000))
(rule (REC_RAND_VAR #b00000010 #x8 #b0000))
(rule (REC_ALL_INC #b00000010 #x1 #b0010))
(rule (REC_ALL_INC #b00000010 #x2 #b0000))
(rule (REC_ALL_INC #b00000010 #x3 #b0000))
(rule (REC_ALL_INC #b00000010 #x4 #b0000))
(rule (REC_ALL_INC #b00000010 #x5 #b0000))
(rule (REC_ALL_INC #b00000010 #x6 #b0000))
(rule (REC_ALL_INC #b00000010 #x7 #b0000))
(rule (REC_ALL_INC #b00000010 #x8 #b0000))
(rule (RAND #b00000011))
(rule (REC_RAND_VAR #b00000011 #x1 #b0100))
(rule (REC_RAND_VAR #b00000011 #x2 #b0000))
(rule (REC_RAND_VAR #b00000011 #x3 #b0000))
(rule (REC_RAND_VAR #b00000011 #x4 #b0000))
(rule (REC_RAND_VAR #b00000011 #x5 #b0000))
(rule (REC_RAND_VAR #b00000011 #x6 #b0000))
(rule (REC_RAND_VAR #b00000011 #x7 #b0000))
(rule (REC_RAND_VAR #b00000011 #x8 #b0000))
(rule (REC_ALL_INC #b00000011 #x1 #b0100))
(rule (REC_ALL_INC #b00000011 #x2 #b0000))
(rule (REC_ALL_INC #b00000011 #x3 #b0000))
(rule (REC_ALL_INC #b00000011 #x4 #b0000))
(rule (REC_ALL_INC #b00000011 #x5 #b0000))
(rule (REC_ALL_INC #b00000011 #x6 #b0000))
(rule (REC_ALL_INC #b00000011 #x7 #b0000))
(rule (REC_ALL_INC #b00000011 #x8 #b0000))
