...
namespace assign {
    class genFact : public InstVisitor<genFact> {
        private:
            ...
            /** return a string representing the trunc, icmp, sext relation **/
            ...
            std::string createBitCast(Value *to, Value *from);
            /** return a string representing GetElementPtr instr **/
            std::string createGetElementPtrInst(Value *to, Value *from, unsigned type);
            std::string createIntToPtrInst(Value *to, Value *from);
        ...
        public:
            genFact(raw_fd_ostream *os, std::map<Instruction*, int>, std::vector<std::string>, std::vector<std::string>, std::vector<std::string>, unsigned, unsigned, unsigned);
