...
namespace assign {
    class genFact : public InstVisitor<genFact> {
        private:
            ...
            std::string createZExt(Value *to, Value *from);
        ...
        public:
            genFact(raw_fd_ostream *os, std::map<Instruction*, int>, std::vector<std::string>, std::vector<std::string>, std::vector<std::string>, unsigned, unsigned, unsigned, unsigned);
