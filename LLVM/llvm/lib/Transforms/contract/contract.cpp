...
cl::opt<std::string> ShareFileName("group", cl::desc("specify the shared_variable file"), cl::value_desc("fileName"), cl::Required);

    struct contract : public FunctionPass {
        static char ID;
        contract() : FunctionPass(ID) {}
        ...
        /** print the UNTAINT_NUMBER && KEY_NUMBER **/
        void printNumber(raw_fd_ostream &f, unsigned input_ind, unsigned input_num, unsigned input_bitset, unsigned rand_n, unsigned key_n){
            ...
            for(unsigned j = 1; j <= input_num; j++)
            {
                ...
                rand_s = "(rule (UNTAINT_NUMBER " + id + ' ' + rand_s + "))" + "\n";
                f << rand_s;
                ...
                if(tokens.size() == 1)
                    ...
                    for(std::vector<std::string>::iterator it = tokens.begin(); it != tokens.end(); it++)
                    {
                        ...
                        if((continue_flag) && (it == tokens.begin()))
                        {
                            ...
                            tmp++;
                            share_map.insert(std::pair<int, share_pair>(tmp, std::make_tuple(last_var, *it, last_id, share_s2)));
                        }
        ...
        void printSpec(raw_fd_ostream &f, unsigned input_s, unsigned input_ind, unsigned input_bitset) {
            ...
            f << "(define-sort BitSet () (_ BitVec " << input_bitset << "))\n" 
              ...
              << "(declare-var UNTAINT_A BitSet)\n"
              << "(declare-var UNTAINT_B BitSet)\n"
              << "(declare-var UNTAINT_C BitSet)\n"
              << "(declare-var ALL_INC_A BitSet)\n"
              << "(declare-var ALL_INC_B BitSet)\n"
              << "(declare-var ALL_INC_C BitSet)\n"
              << "(declare-var UNTAINT_NUM BitSet)\n"
        ...
        void printRule(raw_fd_ostream &f, unsigned input_ind, unsigned input_bitset)
        {
            ...
            f << "; define the function which will be used in the rules\n"
              ...
              << "(declare-rel BVOR_UNTAINT_REC (s s s ind))\n"
              ...
              << "(declare-rel BV_EQUAL_UNTAINT_REC (s s ind))\n"
            ...
            f << "; defining the recursive function ;;;;;;;\n"
              << ";; BV [AND] [UNTAINT_VAR] ;; Times begin from 1 \n"
              << "(rule (=> (and (REC_UNTAINT_VAR var_x Times X) (REC_UNTAINT_VAR var_y Times Y) (BVAND_REC var_x var_y var_z Times) (= tmp (bvand X Y))) (REC_UNTAINT_VAR var_z Times tmp)))\n"
              ...
              << ";; BV [OR] [UNTAINT_VAR]\n"
              << "(rule (=> (and (REC_UNTAINT_VAR var_x Times X) (REC_UNTAINT_VAR var_y Times Y) (BVOR_UNTAINT_REC var_x var_y var_z Times) (BVOR X Y XY)) (REC_UNTAINT_VAR var_z Times XY)))\n"
              << "(rule (=> (and (BVOR_UNTAINT_REC var_x var_y var_z Times) (not (= Times "
              << zero_ind
              << ")) (= Times_New (bvsub Times "
              << one_ind
              << "))) (BVOR_UNTAINT_REC var_x var_y var_z Times_New)))\n"
              << ";; BV [OR] [ALL_INC]\n"
              ...
              << "(rule (=> (and (REC_UNTAINT_VAR var_x Times X) (REC_ALL_INC var_y Times Y) (not (= Times "
              << one_ind
              ...
              << ";; BV [DIFF] [UNTAINT_VAR]\[ALL_INC]\n"
              << "(rule (=> (and (REC_UNTAINT_VAR var_x Times X) (REC_ALL_INC var_y Times Y) (= Times "
              << one_ind
              ...
              << ";; BV [SET_SUM] [UNTAINT_VAR] [UNTAINT_VAR]\n"
              << "(rule (=> (and (REC_UNTAINT_VAR var_x Times X) (REC_UNTAINT_VAR var_y Times Y) (SET_SUM_REC var_x var_y var_z Times) (SET_SUM X Y XY)) (REC_UNTAINT_VAR var_z Times XY)))\n"
              ...
              << "(rule (=> (and (REC_UNTAINT_VAR var_x Times X_R) (REC_UNTAINT_VAR var_y Times Y_R) (REC_ALL_INC var_x Times X_A) (REC_ALL_INC var_y Times Y_A) (UNTAINT_NUMBER Times UNTAINT_NUM) (XOR_RUD1_ALL_INC X_A Y_A X_R Y_R UNTAINT_NUM XY) (XOR_RUD1_ALL_INC_REC var_x var_y var_z Times)) (REC_ALL_INC var_z Times XY)))\n"
              ...
              << ";; BV [BV_EQUAL] ;; generate the same bit vector [UNTAINT_VAR] => [UNTAINT_VAR]\n"
              << "(rule (=> (and (REC_UNTAINT_VAR var_x Times X) (BV_EQUAL_UNTAINT_REC var_x var_y Times)) (REC_UNTAINT_VAR var_y Times X)))\n"
              << "(rule (=> (and (BV_EQUAL_UNTAINT_REC var_x var_y Times) (= Times_New (bvsub Times "
              << one_ind
              << ")) (not (= Times_New "
              << zero_ind
              << "))) (BV_EQUAL_UNTAINT_REC var_x var_y Times_New)))\n"
              ...
              << ";; BV [BV_ZERO] ;; [UNTAINT]\n"
              << "(rule (=> (and (REC_UNTAINT_VAR var_x Times X) (BV_ZERO_REC var_x var_y Times) (= XY " 
              << zero_bit
              << ")) (REC_UNTAINT_VAR var_y Times XY)))\n"
              << "(rule (=> (and (BV_ZERO_REC var_x var_y Times) (= Times_New (bvsub Times "
              << one_ind
              << ")) (not (= Times_New "
              << zero_ind
              << "))) (BV_ZERO_REC var_x var_y Times_New)))\n"
              << ";; BV [IS EMPTY] [UNTAINT_VAR] ;;;; for the [NO KEY] rule\n"
              << ";(rule (=> (and (REC_UNTAINT_VAR var_x Times X) (= Times "
              << one_ind
              << ") (ISEMPTY X int_bool0)) (BV_IS_EMPTY_REC var_x Times int_bool0)))\n"
              << ";(rule (=> (and (REC_UNTAINT_VAR var_x Times X) (ISEMPTY X int_bool0) (not (= Times "
              << one_ind
              << ")) (= Times_New (bvsub Times "
              << one_ind
            ...
            f << ";;;;;;;;;;;;;;;;;;;;;;;;;; beginning of the [RULE] ;;;;;;;;;;;;;;;;;;;;\n"
              << "; rule: [XOR-RUD1] ;; left operand ;; [UNTAINT] + [ANY]\n"
              << ";A => B, B can only be one clause, only A can use <and> to concatenate different clauses\n"
              << ";;new recursive\n"
              << "(rule (=> (and (xor_assign_left to from1) (xor_assign_right to from2) (Time Times) (UNTAINT from1)) (DIFF_LABEL from1 from2)))\n"
              << "(rule (=> (and (xor_assign_left to from1) (xor_assign_right to from2) (Time Times) (UNTAINT from2)) (DIFF_LABEL from2 from1)))\n"
              << "(rule (=> (and (xor_assign_left to from1) (xor_assign_right to from2) (Time Times) (or (and (UNTAINT from1) (BV_DIFF_REC from1 from2 Times int_res0) (not (= int_res0 "
              << zero_bit
              << "))) (and (UNTAINT from2) (BV_DIFF_REC from2 from1 Times int_res1) (not (= int_res1 "
              << zero_bit
              << "))))) (UNTAINT to)))\n"
              << "(rule (=> (and (xor_assign_left to from1) (xor_assign_right to from2) (Time Times) (and (and (UNTAINT from1) (BV_DIFF_REC from1 from2 Times int_res0) (= int_res0 "
              << zero_bit
              << ")) (and (UNTAINT from2) (BV_DIFF_REC from2 from1 Times int_res1) (= int_res1 "
              << zero_bit 
              << ")))) (CHECK_SAME from1 from2)))\n"
              << "(rule (=> (and (xor_assign_left to from1) (xor_assign_right to from2) (Time Times) (or (UNTAINT from1) (UNTAINT from2)) (BV_SAME_REC from1 from2 Times int_res0) (= int_res0 "
              << zero_bit
              << ")) (NORMAL to)))\n"
              << "(rule (=> (and (xor_assign_left to from1) (xor_assign_right to from2) (Time Times) (or (UNTAINT from1) (UNTAINT from2)) (BV_SAME_REC from1 from2 Times int_res0) (not (= int_res0 "
              << zero_bit
              << "))) (TAINT to)))\n"
              << ";; define the array for [UNTAINT_VAR]\n"
              << "(rule (=> (and (xor_assign_left to from1) (xor_assign_right to from2) (Time Times) (or (and (UNTAINT from1) (BV_DIFF_REC from1 from2 Times int_res0) (not (= int_res0 "
              << zero_bit
              << "))) (and (UNTAINT from2) (BV_DIFF_REC from2 from1 Times int_res1) (not (= int_res1 "
              << zero_bit
              ...
              << "(rule (=> (and (xor_assign_left to from1) (xor_assign_right to from2) (Time Times) (or (UNTAINT from1) (UNTAINT from2))) (XOR_RUD1_ALL_INC_REC from1 from2 to Times)))\n"
              << "\n"
              << "; rule [XOR] [TAINT] + [TAINT]\n"
              << "(rule (=> (and (xor_assign_left to from1) (xor_assign_right to from2) (TAINT from1) (TAINT from2)) (TAINT to)))\n"
              << "(rule (=> (and (xor_assign_left to from1) (xor_assign_right to from2) (Time Times) (TAINT from1) (TAINT from2)) (BV_ZERO_REC from1 to Times)))\n"
              << "(rule (=> (and (xor_assign_left to from1) (xor_assign_right to from2) (Time Times) (TAINT from1) (TAINT from2)) (BVOR_ALL_REC from1 from2 to Times)))\n"
              << "\n"
              << "; rule [XOR] [SID] + [SID] ;; TO DO: refinement ;; overlapping with rule [SID]\n"
              << "(rule (=> (and (xor_assign_left to from1) (xor_assign_right to from2) (NORMAL from1) (NORMAL from2)) (INTERSECT_LABEL from1 from2)))\n"
              << "(rule (=> (and (xor_assign_left to from1) (xor_assign_right to from2) (NORMAL from1) (NORMAL from2) (Time Times) (BV_INTERSECT_REC from1 from2 Times int_res0) (= int_res0 "
              << zero_bit
              << ")) (NORMAL to)))\n"
              << "(rule (=> (and (xor_assign_left to from1) (xor_assign_right to from2) (NORMAL from1) (NORMAL from2) (Time Times) (BV_INTERSECT_REC from1 from2 Times int_res0) (not (= int_res0 "
              << zero_bit
              << "))) (TAINT to)))\n"
              << "(rule (=> (and (xor_assign_left to from1) (xor_assign_right to from2) (NORMAL from1) (NORMAL from2) (Time Times)) (BVOR_ALL_REC from1 from2 to Times)))\n"
              << "(rule (=> (and (xor_assign_left to from1) (xor_assign_right to from2) (NORMAL from1) (NORMAL from2) (Time Times)) (BV_ZERO_REC from1 to Times)))\n"
              << "\n";
            f << "; rule [AO-RUD1] [UNTAINT] + [SID] ;; left operand ;; ;;TYPE\n"
              << ";;;; change (not (TAINT xxx)) = (or (IND) (UNTAINT));;;;;;\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (UNTAINT from1) (NORMAL from2)) (INTERSECT_LABEL from1 from2)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (UNTAINT from1) (NORMAL from2) (Time Times) (BV_INTERSECT_REC from1 from2 Times int_res0) (= int_res0 "
              << zero_bit
              << ")) (NORMAL to)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (UNTAINT from1) (NORMAL from2) (Time Times) (BV_INTERSECT_REC from1 from2 Times int_res0) (not (= int_res0 "
              << zero_bit
              << "))) (TAINT to)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (UNTAINT from1) (NORMAL from2) (Time Times)) (BVOR_ALL_REC from1 from2 to Times)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (UNTAINT from1) (NORMAL from2) (Time Times)) (BV_ZERO_REC from1 to Times)))\n"
              << "\n"
              << "; rule [AO-RUD1] [UNTAINT] + [TAINT] ;; TYPE\n"
              << ";; left operand ;; constraint => ALL_INC_left /\ ALL_INC_right = empty\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (TAINT from2) (UNTAINT from1)) (TAINT to)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (TAINT from2) (UNTAINT from1) (Time Times)) (BVOR_ALL_REC from1 from2 to Times)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (TAINT from2) (UNTAINT from1) (Time Times)) (BV_ZERO_REC from1 to Times)))\n"
              << "\n"
              << "; rule [AO-RUD2] ;; right operand ;; [UNTAINT] + [NORMAL] ;; TYPE\n"
              << ";;;; change (not (TAINT xxx)) = (or (IND) (UNTAINT));;;;;;;\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (UNTAINT from2) (NORMAL from1)) (INTERSECT_LABEL from1 from2)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (NORMAL from1) (UNTAINT from2) (Time Times) (BV_INTERSECT_REC from1 from2 Times int_res0) (= int_res0 "
              << zero_bit
              << ")) (NORMAL to)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (NORMAL from1) (UNTAINT from2) (Time Times) (BV_INTERSECT_REC from1 from2 Times int_res0) (not (= int_res0 "
              << zero_bit
              << "))) (TAINT to)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (NORMAL from1) (UNTAINT from2) (Time Times)) (BVOR_ALL_REC from1 from2 to Times)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (NORMAL from1) (UNTAINT from2) (Time Times)) (BV_ZERO_REC from1 to Times)))\n"
              << "\n"
              << ";rule [AO-RUD2] ;; right operand ;; [UNTAINT] + [TAINT]\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (UNTAINT from2) (TAINT from1)) (TAINT to)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (UNTAINT from2) (TAINT from1) (Time Times)) (BVOR_ALL_REC from1 from2 to Times)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (UNTAINT from2) (TAINT from1) (Time Times)) (BV_ZERO_REC from1 to Times)))\n"
              << "; rule [AO-RUD3] ;;; TYPE [UNTAINT] + [UNTAINT]\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (UNTAINT from1) (UNTAINT from2)) (DIFF_LABEL from1 from2)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (UNTAINT from1) (UNTAINT from2)) (DIFF_LABEL from2 from1)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (UNTAINT from1) (UNTAINT from2) (Time Times) (BV_DIFF_REC from1 from2 Times int_res0) (BV_DIFF_REC from2 from1 Times int_res1) (BVOR int_res0 int_res1 int_res2) (not (= int_res2 "
              << zero_bit
              << "))) (NORMAL to)))\n"
            //<< ";; this rule may conflict with the rule [UNTAINT] + [NO KEY] and no intersection is a more strict conidtion for TAINT type\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (UNTAINT from1) (UNTAINT from2) (Time Times) (and (and (BV_DIFF_REC from1 from2 Times int_res0) (= int_res0 "
              << zero_bit
              << ")) (and (BV_DIFF_REC from2 from1 Times int_res1) (= int_res1 "
              << zero_bit
              << ")))) (CHECK_SAME from1 from2)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (Time Times) (UNTAINT from1) (UNTAINT from2) (BV_SAME_REC from1 from2 Times int_res0) (= int_res0 "
              << zero_bit
              << ")) (NORMAL to)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (Time Times) (UNTAINT from1) (UNTAINT from2) (BV_SAME_REC from1 from2 Times int_res0) (not (= int_res0 "
              << zero_bit
              << "))) (TAINT to)))\n"
            
            //<< "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (UNTAINT from1) (UNTAINT from2) (Time Times) (BV_DIFF_REC from1 from2 Times int_res0) (BV_DIFF_REC from2 from1 Times int_res1) (BVOR int_res0 int_res1 int_res2) (= int_res2 "
              //<< zero_bit
              //<< ")) (TAINT to)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (UNTAINT from1) (UNTAINT from2) (Time Times)) (BVOR_ALL_REC from1 from2 to Times)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (UNTAINT from1) (UNTAINT from2) (Time Times)) (BV_ZERO_REC from1 to Times)))\n"
              << "\n";
            f << "; rule [AO] [TAINT] + [TAINT] ;; TYPE\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (TAINT from1) (TAINT from2)) (TAINT to)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (TAINT from1) (TAINT from2) (Time Times)) (BVOR_ALL_REC from1 from2 to Times)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (TAINT from1) (TAINT from2) (Time Times)) (BV_ZERO_REC from1 to Times)))\n"
              << "\n"
              << "; rule [SID] ;; AND OR  ;; TYPE [AO] +  [SID] + [SID]\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (NORMAL from1) (NORMAL from2)) (INTERSECT_LABEL from1 from2)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (NORMAL from1) (NORMAL from2) (Time Times) (BV_INTERSECT_REC from1 from2 Times int_res0) (= int_res0 "
              << zero_bit
              << ")) (NORMAL to)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (NORMAL from1) (NORMAL from2) (Time Times) (BV_INTERSECT_REC from1 from2 Times int_res0) (not (= int_res0 "
              << zero_bit
              << "))) (TAINT to)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (NORMAL from1) (NORMAL from2) (Time Times)) (BVOR_ALL_REC from1 from2 to Times)))\n"
              << "(rule (=> (and (andor_assign_left to from1) (andor_assign_right to from2) (NORMAL from1) (NORMAL from2) (Time Times)) (BV_ZERO_REC from1 to Times)))\n"
              << "\n"
              << "; rule [NOT] UNTAINT -> UNTAINT\n"
              << "(rule (=> (and (not_assign to from1) (UNTAINT from1)) (UNTAINT to)))\n"
              << "(rule (=> (and (not_assign to from1)  (UNTAINT from1) (Time Times)) (BV_EQUAL_UNTAINT_REC from1 to Times)))\n"
              << "(rule (=> (and (not_assign to from1) (UNTAINT from1) (Time Times)) (BV_EQUAL_ALL_REC from1 to Times)))\n"
              << "; rule [NOT] SID -> SID\n"
              << "(rule (=> (and (not_assign to from1) (NORMAL from1)) (NORMAL to)))\n"
              << "(rule (=> (and (not_assign to from1) (NORMAL from1) (Time Times)) (BV_EQUAL_UNTAINT_REC from1 to Times)))\n"
              << "(rule (=> (and (not_assign to from1) (NORMAL from1) (Time Times)) (BV_EQUAL_ALL_REC from1 to Times)))\n"
              << "; rule [NOT] TAINT -> TAINT\n"
              << "(rule (=> (and (not_assign to from1) (TAINT from1)) (TAINT to)))\n"
              << "(rule (=> (and (not_assign to from1) (TAINT from1) (Time Times)) (BV_EQUAL_UNTAINT_REC from1 to Times)))\n"
              << "(rule (=> (and (not_assign to from1) (TAINT from1) (Time Times))(BV_EQUAL_ALL_REC from2 to Times)))\n"
              << "\n"
              << "; rule [No KEY];; TO DO ;;; all the computation will have the decided types ;;; [NO KEY] rule is not necessary\n"
              << "(rule (=> (CONSTANT from1) (NORMAL from1)))\n"
              << ";(rule (=> (and (Time Times) (BVAND_ALL_KEY_REC from1 Times int_res0) (= int_res0 "
              << zero_bit
              << ") (BV_IS_EMPTY_REC from1 Times int_bool0) int_bool0) (NORMAL from1)))\n"
              << "\n"
              /*
              << "; rule [LOAD] + [TAINT]\n"
              << "(rule (=> (and (load_assign to from1) (TAINT from1)) (TAINT to)))\n"
              << "(rule (=> (and (load_assign to from1) (TAINT from1) (Time Times)) (BV_EQUAL_ALL_REC from1 to Times)))\n"
              << "(rule (=> (and (load_assign to from1) (TAINT from1) (Time Times)) (BV_EQUAL_UNTAINT_REC from1 to Times)))\n"
              << "\n"
              << "; rule [LOAD] + [NORMAL]\n"
              << "(rule (=> (and (load_assign to from1) (NORMAL from1)) (NORMAL to)))\n"
              << "(rule (=> (and (load_assign to from1) (NORMAL from1) (Time Times)) (BV_EQUAL_ALL_REC from1 to Times)))\n"
              << "(rule (=> (and (load_assign to from1) (NORMAL from1) (Time Times)) (BV_EQUAL_UNTAINT_REC from1 to Times)))\n"
              << "\n"
              << "; rule [LOAD] + [UNTAINT]\n"
              << "(rule (=> (and (load_assign to from1) (UNTAINT from1)) (UNTAINT to)))\n"
              << "(rule (=> (and (load_assign to from1) (UNTAINT from1) (Time Times)) (BV_EQUAL_ALL_REC from1 to Times)))\n"
              << "(rule (=> (and (load_assign to from1) (UNTAINT from1) (Time Times)) (BV_EQUAL_UNTAINT_REC from1 to Times)))\n"
              << "\n"
              << "; rule [STORE] + [TAINT]\n"
              << "(rule (=> (and (store_assign to from1) (TAINT from1)) (TAINT to)))\n"
              << "(rule (=> (and (store_assign to from1) (TAINT from1) (Time Times)) (BV_EQUAL_ALL_REC from1 to Times)))\n"
              << "(rule (=> (and (store_assign to from1) (TAINT from1) (Time Times)) (BV_EQUAL_UNTAINT_REC from1 to Times)))\n"
              << "\n"
              << "; rule [STORE] + [NORMAL]\n"
              << "(rule (=> (and (store_assign to from1) (NORMAL from1)) (NORMAL to)))\n"
              << "(rule (=> (and (store_assign to from1) (NORMAL from1) (Time Times)) (BV_EQUAL_ALL_REC from1 to Times)))\n"
              << "(rule (=> (and (store_assign to from1) (NORMAL from1) (Time Times)) (BV_EQUAL_UNTAINT_REC from1 to Times)))\n"
              << "\n"
              << "; rule [STORE] + [UNTAINT]\n"
              << "(rule (=> (and (store_assign to from1) (UNTAINT from1)) (UNTAINT to)))\n"
              << "(rule (=> (and (store_assign to from1) (UNTAINT from1) (Time Times)) (BV_EQUAL_ALL_REC from1 to Times)))\n"
              << "(rule (=> (and (store_assign to from1) (UNTAINT from1) (Time Times)) (BV_EQUAL_UNTAINT_REC from1 to Times)))\n"
              << "\n"
              */
              << ";rule [assign] + [KET_SENSITIVE]\n"
              << "(rule (=> (and (assign to from) (TAINT from)) (TAINT to)))\n"
              << ";rule [assign] + [NORMAL]\n"
              << "(rule (=> (and (assign to from) (NORMAL from)) (NORMAL to)))\n"
              << ";rule [assign] + [UNTAINT]\n"
              << "(rule (=> (and (assign to from) (UNTAINT from)) (UNTAINT to)))\n"
              << ";rule [assign] array\n"
              << "(rule (=> (and (assign to from) (Time Times)) (BV_EQUAL_ALL_REC from to Times)))\n"
              << "(rule (=> (and (assign to from) (Time Times)) (BV_EQUAL_UNTAINT_REC from to Times)))\n"
              << "\n"
              << "; rule [binary_constant] + [TAINT]\n"
              << "(rule (=> (and (binary_constant to from1) (TAINT from1)) (TAINT to)))\n"
              << "; rule [binary_constant] + [NORMAL]\n"
              << "(rule (=> (and (binary_constant to from1) (NORMAL from1)) (NORMAL to)))\n"
              << "; rule [binary_constant] + [UNTAINT]\n"
              << "(rule (=> (and (binary_constant to from1) (UNTAINT from1)) (UNTAINT to)))\n"
              << "; rule [binary_constant] array\n"
              << "(rule (=> (and (binary_constant to from1) (Time Times)) (BV_EQUAL_ALL_REC from1 to Times)))\n"
              << "(rule (=> (and (binary_constant to from1) (Time Times)) (BV_EQUAL_UNTAINT_REC from1 to Times)))\n"
              << "\n"
              ...
              */
              ...
              << "(rule (=> (and (xor_assign_left to from1) (xor_assign_right to from2) (share to from1) (TAINT from2)) (HD_SENSITIVE to from1)))\n"
              << "(rule (=> (and (xor_assign_left to from1) (xor_assign_right to from2) (share to from2) (TAINT from1)) (HD_SENSITIVE to from2)))\n"
              << ";; define the case for HD sensitive (indirect)\n"
              << "(rule (=> (and (share to from) (equal_assign from_e from) (equal_assign to_e to) (xor_assign_left to_e from_e) (xor_assign_right to_e from1) (TAINT from1)) (HD_SENSITIVE to from)))\n"
              << "(rule (=> (and (share to from) (equal_assign from_e from) (equal_assign to_e to) (xor_assign_left to_e from1) (xor_assign_right to_e from_e) (TAINT from1)) (HD_SENSITIVE to from)))\n"
              << "\n"
        ...
        {
            f << ";query NORMAL type\n"
              << "(query NORMAL :print-answer true)\n"
              << ";query TAINT type\n"
              << "(query TAINT :print-answer true)\n"
              << ";query UNTAINT type\n"
              << "(query UNTAINT :print-answer true)\n"
              << ";query under HD model, TAINT\n"
        ...
        virtual bool runOnFunction(Function &F) {
            ...
            std::vector<std::string> UNTAINT_VAR;
            std::vector<std::string> CONSTANT_VAR;
            std::vector<std::string> KEY_VAR;
            UNTAINT_VAR = InFileTypeSet("UNTAINT", InputFileName);
            CONSTANT_VAR = InFileTypeSet("CONSTANT", InputFileName);
            KEY_VAR = InFileTypeSet("KEY", InputFileName);
            /** print the UNTAINT_NUM and KEY_NUM **/
            unsigned rand_num = (1 << UNTAINT_VAR.size()) - 1;
            unsigned key_num = ((1 << (UNTAINT_VAR.size() + KEY_VAR.size())) - 1) - rand_num;
            std::string UNTAINT_NUM, KEY_NUM;
            ...
            index_num = ceil(((float)(UNTAINT_VAR.size() + CONSTANT_VAR.size() + KEY_VAR.size()))/4);
            ...
            /** User Input TAINT data **/
            (*outFile) << "; user specify the sensitive variable\n";
            /** TODO: add more facts **/
            /** genFact **/
            assign::genFact fact(outFile, ID_map, UNTAINT_VAR, CONSTANT_VAR, KEY_VAR, input_s, index, index_num, input_bitset);
            fact.visit(F);
    ...
    char contract::ID = 0;
    static RegisterPass<contract> X("contract", "datalog based front-end for simple assignment analysis",
