...
namespace assign {
    class genFact : public InstVisitor<genFact> {
        ...
        public:
            genFact(raw_fd_ostream *os, std::map<Instruction*, int> &IDMap, std::vector<std::string>, std::vector<std::string>, std::vector<std::string>, unsigned, unsigned, unsigned, unsigned);
