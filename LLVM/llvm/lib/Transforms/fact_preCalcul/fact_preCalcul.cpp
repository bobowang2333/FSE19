...
cl::opt<std::string> ShareFileName("share", cl::desc("specify the shared_variable file"), cl::value_desc("fileName"), cl::Required);
    ...
    struct factPre : public FunctionPass {
        static char ID;
        factPre() : FunctionPass(ID) {}
        ...
        virtual bool runOnFunction(Function &F) {
            ...
            assign::genFact fact(outFile, ID_map, RAND_VAR, CONSTANT_VAR, KEY_VAR, input_s, index, index_num, input_bitset, REC_ALL_INC, REC_RAND_VAR);
            fact.visit(F);
    ...
    char factPre::ID = 0;
    static RegisterPass<factPre> X("factPre", "datalog based front-end for simple assignment analysis",
