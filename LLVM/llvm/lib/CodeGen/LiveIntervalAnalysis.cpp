...
void LiveIntervals::printInstrs(raw_ostream &OS) const {
  ...
  //first clear the content of the file
    std::string path = "memOperand.log"; // for the shared variable info
    std::string path2 = "memOriginal.log"; // for the original mapping between vreg and variables before register coalescing
    std::string path3 = "memBool.log"; //for the bool instruction type
    std::error_code ec;
    ...
    (*outFile) << "********** MACHINEINSTRS **********\n";
    (*outFile2) << "********** MACHINEINSTRS **********\n";
    (*outFile3) << "********** MACHINEINSTRS **********\n";
    outFile->close();
    outFile2->close();
    outFile3->close();
  MF->print(OS, Indexes);
